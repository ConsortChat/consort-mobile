...
data class IntentSharedFile (
...
)
 {
  ...
  override fun toString(): String {
    return "IntentSharedFile(name=$name, mimeType=$mimeType, bytes=${bytes.contentToString()})"
  }
}
...
data class AndroidIntentSendEvent (
...
) : AndroidIntentEvent()
 {
  ...
  override fun toString(): String {
    return "AndroidIntentSendEvent(action=$action, extraText=$extraText, extraStream=$extraStream)"
  }
}
