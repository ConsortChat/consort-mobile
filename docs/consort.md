...
- Android is built in Google Play and F-Droid variants.
  The F-Droid variant excludes Firebase from its dependency graph, not
  merely disabling Firebase at runtime. See
