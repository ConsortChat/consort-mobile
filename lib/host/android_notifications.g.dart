...
class NotificationChannel {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(id, other.id) && _deepEquals(importance, other.importance) && _deepEquals(name, other.name) && _deepEquals(lightsEnabled, other.lightsEnabled) && _deepEquals(soundUrl, other.soundUrl) && _deepEquals(vibrationPattern, other.vibrationPattern);
  }
  ...
  @override
  String toString() {
    return 'NotificationChannel(id: $id, importance: $importance, name: $name, lightsEnabled: $lightsEnabled, soundUrl: $soundUrl, vibrationPattern: $vibrationPattern)';
  }
}
...
class AndroidIntent {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(action, other.action) && _deepEquals(dataUrl, other.dataUrl) && _deepEquals(flags, other.flags);
  }
  ...
  @override
  String toString() {
    return 'AndroidIntent(action: $action, dataUrl: $dataUrl, flags: $flags)';
  }
}
...
class PendingIntent {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(requestCode, other.requestCode) && _deepEquals(intent, other.intent) && _deepEquals(flags, other.flags);
  }
  ...
  @override
  String toString() {
    return 'PendingIntent(requestCode: $requestCode, intent: $intent, flags: $flags)';
  }
}
...
class InboxStyle {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(summaryText, other.summaryText);
  }
  ...
  @override
  String toString() {
    return 'InboxStyle(summaryText: $summaryText)';
  }
}
...
class Person {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(iconBitmap, other.iconBitmap) && _deepEquals(key, other.key) && _deepEquals(name, other.name);
  }
  ...
  @override
  String toString() {
    return 'Person(iconBitmap: $iconBitmap, key: $key, name: $name)';
  }
}
...
class MessagingStyle {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(user, other.user) && _deepEquals(conversationTitle, other.conversationTitle) && _deepEquals(messages, other.messages) && _deepEquals(isGroupConversation, other.isGroupConversation);
  }
  ...
  @override
  String toString() {
    return 'MessagingStyle(user: $user, conversationTitle: $conversationTitle, messages: $messages, isGroupConversation: $isGroupConversation)';
  }
}
...
class StatusBarNotification {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(id, other.id) && _deepEquals(tag, other.tag) && _deepEquals(notification, other.notification);
  }
  ...
  @override
  String toString() {
    return 'StatusBarNotification(id: $id, tag: $tag, notification: $notification)';
  }
}
...
class StoredNotificationSound {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(fileName, other.fileName) && _deepEquals(isOwned, other.isOwned) && _deepEquals(contentUrl, other.contentUrl);
  }
  ...
  @override
  String toString() {
    return 'StoredNotificationSound(fileName: $fileName, isOwned: $isOwned, contentUrl: $contentUrl)';
  }
}
...
class AndroidNotificationHostApi {
  ...
  Future<List<NotificationChannel>> getNotificationChannels() async {
    ...
    ;
    return (pigeonVar_replyValue! as List<Object?>).cast<NotificationChannel>();
  }
  ...
  Future<List<StoredNotificationSound>> listStoredSoundsInNotificationsDirectory() async {
    ...
    ;
    return (pigeonVar_replyValue! as List<Object?>).cast<StoredNotificationSound>();
  }
  ...
  Future<List<StatusBarNotification>> getActiveNotifications({required List<String> desiredNotificationExtras, required List<String> desiredMessageExtras, required bool includeMessagingStyle, }) async {
    ...
    ;
    return (pigeonVar_replyValue! as List<Object?>).cast<StatusBarNotification>();
  }
  ...
  Future<bool> requestNotificationPermission() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.zulip.AndroidNotificationHostApi.requestNotificationPermission$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
