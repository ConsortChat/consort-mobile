...
sealed class Event {
  ...
  factory Event.fromJson(Map<String, dynamic> json) {
    switch (json['type'] as String) {
      ...
      case 'jitsi_occupancy': return JitsiOccupancyEvent.fromJson(json);
      case 'lounge_rooms': return LoungeRoomsChangedEvent.fromJson(json);
      case 'lounge_knock': return LoungeKnockEvent.fromJson(json);
...
class ChannelUpdateEvent extends ChannelEvent {
  ...
  static Object? _readValue(Map<dynamic, dynamic> json, String key) {
    ...
    switch (ChannelPropertyName.fromRawString(json['property'] as String)) {
      ...
      case ChannelPropertyName.canCreateRoomsGroup:
        return GroupSettingValue.fromJson(value);
      case ChannelPropertyName.isRecentlyActive:
        return value as bool;
      case ChannelPropertyName.streamWeeklyTraffic:
        return value as int?;
      case ChannelPropertyName.voiceVideoEnabled:
      case ChannelPropertyName.textChatDisabled:
      case ChannelPropertyName.isLounge:
        return value as bool;
      case ChannelPropertyName.callDoorPolicy:
        return value as String;
      case null:
        return null;
    }
...
/// A live occupancy update from Consort's Jitsi integration.
class JitsiOccupancyEvent extends Event {
  JitsiOccupancyEvent({required super.id, required this.room});

  @override
  String get type => 'jitsi_occupancy';

  final CallOccupancy room;

  factory JitsiOccupancyEvent.fromJson(Map<String, dynamic> json) =>
    JitsiOccupancyEvent(
      id: (json['id'] as num).toInt(),
      room: CallOccupancy.fromJson(json),
    );
  ...
  Map<String, dynamic> toJson() => {
    'id': id,
    'type': type,
    if (room.streamId != null) 'stream_id': room.streamId,
    if (room.userIds != null) 'user_ids': room.userIds,
    if (room.loungeRoomId != null) 'lounge_room_id': room.loungeRoomId,
    'active': room.active,
    'count': room.count,
    'occupants': room.occupants.map((occupant) => {
      'name': occupant.name,
      'user_id': occupant.userId,
    }).toList(),
  };
}

/// A signal that the visible room list for a lounge channel changed.
class LoungeRoomsChangedEvent extends Event {
  LoungeRoomsChangedEvent({required super.id, required this.channelId});

  @override
  String get type => 'lounge_rooms';

  final int channelId;

  factory LoungeRoomsChangedEvent.fromJson(Map<String, dynamic> json) =>
    LoungeRoomsChangedEvent(
      id: (json['id'] as num).toInt(),
  ...
  @override
  Map<String, dynamic> toJson() =>
    {'id': id, 'type': type, 'channel_id': channelId};
}

/// An authenticated-user or guest knock sent to lounge-room doormen.
class LoungeKnockEvent extends Event {
  LoungeKnockEvent({
    required super.id,
  ...
  factory LoungeKnockEvent.fromJson(Map<String, dynamic> json) =>
    LoungeKnockEvent(
      id: (json['id'] as num).toInt(),
      roomId: (json['room_id'] as num).toInt(),
      userId: (json['user_id'] as num?)?.toInt(),
      guestKnockId: json['guest_knock_id'] as String?,
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (guestKnockId != null) 'guest_knock_id': guestKnockId,
