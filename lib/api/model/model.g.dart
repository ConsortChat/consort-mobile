...
ZulipStream _$ZulipStreamFromJson(Map<String, dynamic> json) => ZulipStream(
  ...
  canCreateRoomsGroup: json['can_create_rooms_group'] == null
      ? null
      : GroupSettingValue.fromJson(json['can_create_rooms_group']),
  isRecentlyActive: json['is_recently_active'] as bool?,
  streamWeeklyTraffic: (json['stream_weekly_traffic'] as num?)?.toInt(),
  voiceVideoEnabled: json['voice_video_enabled'] as bool? ?? false,
  textChatDisabled: json['text_chat_disabled'] as bool? ?? false,
  isLounge: json['is_lounge'] as bool? ?? false,
  callDoorPolicy: json['call_door_policy'] as String? ?? 'anarchy',
);
...
Map<String, dynamic> _$ZulipStreamToJson(ZulipStream instance) =>
    <String, dynamic>{
      ...
      'can_create_rooms_group': instance.canCreateRoomsGroup,
      'is_recently_active': instance.isRecentlyActive,
      'stream_weekly_traffic': instance.streamWeeklyTraffic,
      'voice_video_enabled': instance.voiceVideoEnabled,
      'text_chat_disabled': instance.textChatDisabled,
      'is_lounge': instance.isLounge,
      'call_door_policy': instance.callDoorPolicy,
    };
...
const _$ChannelPropertyNameEnumMap = {
  ...
  ChannelPropertyName.canCreateRoomsGroup: 'can_create_rooms_group',
  ChannelPropertyName.isRecentlyActive: 'is_recently_active',
  ChannelPropertyName.streamWeeklyTraffic: 'stream_weekly_traffic',
  ChannelPropertyName.voiceVideoEnabled: 'voice_video_enabled',
  ChannelPropertyName.textChatDisabled: 'text_chat_disabled',
  ChannelPropertyName.isLounge: 'is_lounge',
  ChannelPropertyName.callDoorPolicy: 'call_door_policy',
};
