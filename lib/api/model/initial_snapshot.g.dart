...
InitialSnapshot _$InitialSnapshotFromJson(
  ...
  serverJitsiJwtEnabled: json['server_jitsi_jwt_enabled'] as bool? ?? false,
  serverJitsiServerUrl: json['server_jitsi_server_url'] == null
      ? null
      : Uri.parse(json['server_jitsi_server_url'] as String),
...
Map<String, dynamic> _$InitialSnapshotToJson(
  ...
  'server_jitsi_jwt_enabled': instance.serverJitsiJwtEnabled,
  'server_jitsi_server_url': instance.serverJitsiServerUrl?.toString(),
