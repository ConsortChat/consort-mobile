...
class ZulipStream {
  ...
  // Consort channel kinds and call-door configuration.  Defaults preserve
  // compatibility with unmodified Zulip servers.
  @JsonKey(defaultValue: false)
  ...
  ZulipStream({
    ...
    required this.canCreateRoomsGroup,
    required this.isRecentlyActive,
    required this.streamWeeklyTraffic,
    required this.voiceVideoEnabled,
    required this.textChatDisabled,
    required this.isLounge,
    required this.callDoorPolicy,
  });
  ...
  factory ZulipStream.fromSubscription(Subscription subscription) {
    return ZulipStream(
      ...
      canCreateRoomsGroup: subscription.canCreateRoomsGroup,
      isRecentlyActive: subscription.isRecentlyActive,
      streamWeeklyTraffic: subscription.streamWeeklyTraffic,
      voiceVideoEnabled: subscription.voiceVideoEnabled,
      textChatDisabled: subscription.textChatDisabled,
      isLounge: subscription.isLounge,
      callDoorPolicy: subscription.callDoorPolicy,
    );
  }
...
class Subscription extends ZulipStream {
  ...
  Subscription({
    ...
    required super.canCreateRoomsGroup,
    required super.isRecentlyActive,
    required super.streamWeeklyTraffic,
    required super.voiceVideoEnabled,
    required super.textChatDisabled,
    required super.isLounge,
    required super.callDoorPolicy,
