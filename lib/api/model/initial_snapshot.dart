...
class InitialSnapshot {
  ...
  /// Whether this server supports Consort's authenticated Jitsi API.
  @JsonKey(defaultValue: false)
  final bool serverJitsiJwtEnabled;

  /// The configured Jitsi origin, when supplied by a Consort server.
  final Uri? serverJitsiServerUrl;
  ...
  InitialSnapshot({
    ...
    required this.serverJitsiJwtEnabled,
