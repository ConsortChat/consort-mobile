      ...
      case ChannelUpdateEvent():
        ...
        switch (event.property!) {
          ...
          case ChannelPropertyName.canCreateRoomsGroup:
            stream.canCreateRoomsGroup = event.value as GroupSettingValue;
          ...
          case ChannelPropertyName.voiceVideoEnabled:
            stream.voiceVideoEnabled = event.value as bool;
          case ChannelPropertyName.textChatDisabled:
            stream.textChatDisabled = event.value as bool;
          case ChannelPropertyName.isLounge:
            stream.isLounge = event.value as bool;
          case ChannelPropertyName.callDoorPolicy:
            stream.callDoorPolicy = event.value as String;
        }
    }
  }
