...
class PerAccountStore extends PerAccountStoreBase with
  ...
  factory PerAccountStore.fromInitialSnapshot({
    ...
    final consort = ConsortCallStore(core: core,
      enabled: initialSnapshot.serverJitsiJwtEnabled);
  ...
  final ConsortCallStore consort;
  ...
  Future<void> handleEvent(Event event) async {
    ...
    switch (event) {
      ...
      case JitsiOccupancyEvent() || LoungeRoomsChangedEvent() || LoungeKnockEvent():
        consort.handleEvent(event);
        notifyListeners();
    }
  }
