...
ZulipStream stream({
  ...
  GroupSettingValue? canCreateRoomsGroup,
  bool? isRecentlyActive,
  int? streamWeeklyTraffic,
  bool? voiceVideoEnabled,
  bool? textChatDisabled,
  bool? isLounge,
  String? callDoorPolicy,
}) {
  ...
  return ZulipStream(
    ...
    canCreateRoomsGroup: canCreateRoomsGroup,
    isRecentlyActive: isRecentlyActive ?? true,
    streamWeeklyTraffic: streamWeeklyTraffic,
    voiceVideoEnabled: voiceVideoEnabled ?? false,
    textChatDisabled: textChatDisabled ?? false,
    isLounge: isLounge ?? false,
    callDoorPolicy: callDoorPolicy ?? 'anarchy',
  );
}
...
Subscription subscription(
  ...
  return Subscription(
    ...
    canCreateRoomsGroup: stream.canCreateRoomsGroup,
    isRecentlyActive: stream.isRecentlyActive,
    streamWeeklyTraffic: stream.streamWeeklyTraffic,
    voiceVideoEnabled: stream.voiceVideoEnabled,
    textChatDisabled: stream.textChatDisabled,
    isLounge: stream.isLounge,
    callDoorPolicy: stream.callDoorPolicy,
...
InitialSnapshot initialSnapshot({
  ...
  bool? serverJitsiJwtEnabled,
  Uri? serverJitsiServerUrl,
  ...
  return InitialSnapshot(
    ...
    serverJitsiJwtEnabled: serverJitsiJwtEnabled ?? false,
